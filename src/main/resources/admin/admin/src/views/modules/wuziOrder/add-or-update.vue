    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="订单编号" prop="wuziOrderUuidNumber">
                       <el-input v-model="ruleForm.wuziOrderUuidNumber"
                                 placeholder="订单编号" clearable  :readonly="ro.wuziOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="订单编号" prop="wuziOrderUuidNumber">
                           <el-input v-model="ruleForm.wuziOrderUuidNumber"
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    wuziOrderUuidNumber: new Date().getTime(),
                    wuziId: '',
                    yonghuId: '',
                    buyNumber: '',
                    wuziOrderTypes: '',
