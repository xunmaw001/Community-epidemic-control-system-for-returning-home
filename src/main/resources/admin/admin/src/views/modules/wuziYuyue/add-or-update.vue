    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='wuzi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="物资地点" prop="wuziAddress">
                        <el-input v-model="wuziForm.wuziAddress"
                                  placeholder="物资地点" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="物资地点" prop="wuziAddress">
                            <el-input v-model="ruleForm.wuziAddress"
                                      placeholder="物资地点" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='wuzi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="赞" prop="zanNumber">
                        <el-input v-model="wuziForm.zanNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='wuzi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="踩" prop="caiNumber">
                        <el-input v-model="wuziForm.caiNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='wuzi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="物资热度" prop="wuziClicknum">
                        <el-input v-model="wuziForm.wuziClicknum"
                                  placeholder="物资热度" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="物资热度" prop="wuziClicknum">
                            <el-input v-model="ruleForm.wuziClicknum"
                                      placeholder="物资热度" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="捐赠编号" prop="wuziYuyueUuidNumber">
                       <el-input v-model="ruleForm.wuziYuyueUuidNumber"
                                 placeholder="捐赠编号" clearable  :readonly="ro.wuziYuyueUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="捐赠编号" prop="wuziYuyueUuidNumber">
                           <el-input v-model="ruleForm.wuziYuyueUuidNumber"
                                     placeholder="捐赠编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="理由" prop="wuziYuyueText">
                        <el-input type="textarea"  :readonly="ro.wuziYuyueText" v-model="ruleForm.wuziYuyueText" placeholder="理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.wuziYuyueText" label="理由" prop="wuziYuyueText">
                            <span v-html="ruleForm.wuziYuyueText"></span>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="捐赠数量" prop="wuziShuliang">
                       <el-input v-model="ruleForm.wuziShuliang"
                                 placeholder="捐赠数量" clearable  :readonly="ro.wuziShuliang"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="捐赠数量" prop="wuziShuliang">
                           <el-input v-model="ruleForm.wuziShuliang"
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.wuziYuyueYesnoTypes" label="捐赠状态" prop="wuziYuyueYesnoTypes">
                        <el-input v-model="ruleForm.wuziYuyueYesnoValue" placeholder="捐赠状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.wuziYuyueYesnoText" label="审核回复" prop="wuziYuyueYesnoText">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.wuziYuyueShenheTime" label="审核时间" prop="wuziYuyueShenheTime">
                        <span v-html="ruleForm.wuziYuyueShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    wuziYuyueShenheTime: false,
                },
                ruleForm: {
                    wuziYuyueUuidNumber: new Date().getTime(),
                    wuziId: '',
                    yonghuId: '',
                    wuziYuyueText: '',
                    insertTime: '',
                ...
                rules: {
                   ...
                   insertTime: [
                              { required: true, message: '物资捐赠不能为空', trigger: 'blur' },
                          ],
                   wuziShuliang: [
