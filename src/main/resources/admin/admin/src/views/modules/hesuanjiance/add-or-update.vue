    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.jianceTime"  class="input" label="检测时间" prop="jianceTime">
                        <el-date-picker
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.hesuanjianceContent"  label="备注" prop="hesuanjianceContent">
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.hesuanjianceContent = _this.ruleForm.hesuanjianceContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.hesuanjianceContent = this.ruleForm.hesuanjianceContent.replaceAll(this.$base.url,"");
                        this.$http({
