        ...
        <el-dialog title="审核" :visible.sync="wuziYuyueYesnoTypesVisible">
            <el-form :model="form">
                ...
                <el-form-item label="审核" >
                    <el-select v-model="form.wuziYuyueYesnoTypes" placeholder="请选择捐赠状态">
                        <el-option label="同意" value="2"></el-option>
                        <el-option label="拒绝" value="3"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="审核回复">
                    <el-input type="textarea" v-model="form.wuziYuyueYesnoText" placeholder="审核回复"></el-input>
                </el-form-item>
            </el-form>
        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '捐赠编号' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.wuziYuyueUuidNumber" placeholder="捐赠编号" clearable></el-input>
                     </el-form-item>
                                                 
                     <el-form-item :label="contents.inputTitle == 1 ? '捐赠状态' : ''">
                        <el-select v-model="searchForm.wuziYuyueYesnoTypes" placeholder="请选择捐赠状态">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/yiqingfanxiangguankong/upload/wuziYuyueMuBan.xls"
                        >批量导入物资捐赠数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('wuziYuyue','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="wuziYuyueUuidNumber"
                                   header-align="center"
                                   label="捐赠编号">
                        <template slot-scope="scope">
                            {{scope.row.wuziYuyueUuidNumber}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="wuziYuyueText"
                                      ...
                                      label="理由">
                        <template slot-scope="scope">
                            <span v-if="scope.row.wuziYuyueText != null &&scope.row.wuziYuyueText.length>10">
                                {{scope.row.wuziYuyueText.slice(0,10)}}...
                            </span>
                            <span v-else>
                                {{scope.row.wuziYuyueText}}
                            </span>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="wuziYuyueShenheTime"
                                   header-align="center"
                                   label="审核时间">
                        <template slot-scope="scope">
                            {{scope.row.wuziYuyueShenheTime}}
                        </template>
                    </el-table-column>
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                //级联表字段
                     ...
                     '电子邮箱': 'yonghuEmail',
                //本表字段
                     '捐赠编号': "wuziYuyueUuidNumber",
                     '理由': "wuziYuyueText",
                     '物资捐赠': "insertTime",
                     '捐赠数量': "wuziShuliang",
                     '捐赠状态': "wuziYuyueYesnoValue",
                     '审核回复': "wuziYuyueYesnoText",
                     '审核时间': "wuziYuyueShenheTime",
            },
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.wuziYuyueUuidNumber!= '' && this.searchForm.wuziYuyueUuidNumber!= undefined) {
                    params['wuziYuyueUuidNumber'] = '%' + this.searchForm.wuziYuyueUuidNumber + '%'
                }
            ...
            wuziYuyueUploadError(data){
                ...
                _this.form.wuziYuyueYesnoTypes = "请选择捐赠状态";
                _this.wuziYuyueYesnoTypesVisible = true;
            },

            wuziYuyueYesnoTypesShenhe() {
                let _this = this;
                if(_this.form.wuziYuyueYesnoTypes == "请选择捐赠状态"){
