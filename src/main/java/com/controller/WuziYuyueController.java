...
public class WuziYuyueController {
    ...
    @Autowired
    private HesuanjianceService hesuanjianceService;//核酸检测
    @Autowired
    ...
    */
    ...
    public R save(@RequestBody WuziYuyueEntity wuziYuyue, HttpServletRequest request){
        ...
        Wrapper<WuziYuyueEntity> queryWrapper = new EntityWrapper<WuziYuyueEntity>()
            ...
            .eq("wuzi_shuliang", wuziYuyue.getWuziShuliang())
...
//        else if("用户".equals(role))
//            wuziYuyue.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        if("".equals(wuziYuyue.getWuziYuyueText()) || "null".equals(wuziYuyue.getWuziYuyueText())){
                wuziYuyue.setWuziYuyueText(null);
        }
        if("".equals(wuziYuyue.getWuziYuyueYesnoText()) || "null".equals(wuziYuyue.getWuziYuyueYesnoText())){
                wuziYuyue.setWuziYuyueYesnoText(null);
        }
...
//                            wuziYuyueEntity.setWuziYuyueUuidNumber(data.get(0));                    //捐赠编号 要改的
//                            wuziYuyueEntity.setWuziId(Integer.valueOf(data.get(0)));   //物资 要改的
//                            wuziYuyueEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
//                            wuziYuyueEntity.setWuziYuyueText(data.get(0));                    //理由 要改的
//                            wuziYuyueEntity.setInsertTime(date);//时间
//                            wuziYuyueEntity.setWuziShuliang(Integer.valueOf(data.get(0)));   //捐赠数量 要改的
//                            wuziYuyueEntity.setWuziYuyueYesnoTypes(Integer.valueOf(data.get(0)));   //捐赠状态 要改的
//                            wuziYuyueEntity.setWuziYuyueYesnoText(data.get(0));                    //审核回复 要改的
