    ...
    */
    ...
    public R save(@RequestBody WuziEntity wuzi, HttpServletRequest request){
        ...
        Wrapper<WuziEntity> queryWrapper = new EntityWrapper<WuziEntity>()
            ...
            .eq("wuzi_address", wuzi.getWuziAddress())
            .eq("zan_number", wuzi.getZanNumber())
            .eq("cai_number", wuzi.getCaiNumber())
...
//            return R.error(511,"永远不会进入");
        ...
        if("".equals(wuzi.getWuziContent()) || "null".equals(wuzi.getWuziContent())){
                wuzi.setWuziContent(null);
        }
...
//                            wuziEntity.setWuziAddress(data.get(0));                    //物资地点 要改的
//                            wuziEntity.setZanNumber(Integer.valueOf(data.get(0)));   //赞 要改的
//                            wuziEntity.setCaiNumber(Integer.valueOf(data.get(0)));   //踩 要改的
    ...
    public R detail(@PathVariable("id") Integer id, HttpServletRequest request){
        ...
        WuziEntity wuzi = wuziService.selectById(id);
            if(wuzi !=null){
                ...
                //点击数量加1
                wuzi.setWuziClicknum(wuzi.getWuziClicknum()+1);
